...
class InterfazUsuario:            
    ...
    def __init__(self):
        ...
        Boton = tk.Button(self.FrameBotones, text="Calcular" ,bg= "lightgreen", command=self.BotonCalcular.Calcular, font=("Arial", 10, "italic"))
        Boton.pack(side= "left",pady=10, padx=8)

        Boton = tk.Button(self.FrameBotones, text="Limpiar", bg="lightcoral", command=self.Limpiar, font=("Arial", 10, "italic"))
        Boton.pack(side= "left", pady=10, padx=8)
